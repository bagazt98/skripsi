...
<div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">
        <?php foreach ($baner as $b) : ?>
            <div class="owl-carousel-item position-relative" data-dot="<?= base_url('assets/img/banner/') . $b['gambar']; ?> ">
                <img class="img-fluid" src="<?= base_url('assets/img/banner/') . $b['gambar']; ?> " alt="">
