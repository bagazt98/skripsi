                            ...
                            <tbody>
                                <?php foreach ($rekap_zakat as $zakat) : ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><?= ($zakat->zakat_masuk === null) ? 0 : (($zakat->bentuk_zakat === 'uang tunai') ? ($zakat->zakat_masuk) : $zakat->zakat_masuk) ?></td>
                                        <?php $zakat_keluar = $this->zakat_fitrah_m->rekapZakatKeluar($zakat->bentuk_zakat) ?>
                                        <td class="text-right"><?= ($zakat_keluar === null) ? 0 : (($zakat->bentuk_zakat === 'uang tunai') ? ($zakat_keluar) : $zakat_keluar) ?></td>
                                        <td class="text-right"><?= ($zakat->bentuk_zakat === 'uang tunai') ? ($zakat->zakat_masuk - $zakat_keluar) : $zakat->zakat_masuk - $zakat_keluar ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
