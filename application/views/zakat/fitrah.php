	...
	<div class="row">
		<div class="col-lg">
			<div class="form-group row">
				<?= form_error('fu', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
					...
					<?php foreach ($zakat as $s) : ?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url('zakat/hapusfitrah/') . $s['id_transaksi']; ?>" class="badge rounded-pill bg-danger">Delete</a>
							</td>
						</tr>
						<?php $i++; ?>
			...
			<div class="modal-content">
				...
				<form action="<?= base_url('zakat/fitrah'); ?>" method="post" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-4">
								<input type="hidden" name="kode_transaksi" id="kode_transaksi" value="ZF">
