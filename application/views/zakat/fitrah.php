    ...
    <div class="row">
        <div class="col-lg">
            <div class="form-group row">
                <?= form_error('fitrah', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                ...
                <?php $i = 1; ?>   
                    <?php foreach ($fitrah as $s) : ?>
                        <tr>
                            ...
                            <td><?= $s['dibuat_oleh']; ?></td>
                            <td>                              
                                <a href="<?= base_url('zakat/fitrahubah/') . $s['id']; ?>" class="badge rounded-pill bg-success">Edit</a>
                                <a href="<?= base_url('zakat/hapusFitrah1/') . $s['id']; ?>" class="badge rounded-pill bg-danger">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('zakat/fitrah'); ?>" method="post" enctype="multipart/form-data">
