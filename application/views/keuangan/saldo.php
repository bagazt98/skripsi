                ...
                <tbody>
                    ...
                    <?php foreach ($saldo_kas as $kas) : ?>
                        <tr>
                            ...
                            <td class="text-right"><?= ($kas['pemasukan'] === null) ? 0 : ($kas['pemasukan']) ?></td>
                            <td class="text-right"><?= ($kas['pengeluaran'] === null) ? 0 : ($kas['pengeluaran']) ?></td>
                            <td class="text-right"><?= ($kas['pemasukan'] - $kas['pengeluaran']) ?></td>
                        </tr>
                        <?php $i++; ?>
