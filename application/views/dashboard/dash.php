						...
						<div class="row">
							<div class="col-9">
								<div class="d-flex align-items-center align-self-start">
									<h3 class="mb-0"><?= empty($kas_masjid->saldo) ? (0) : ($kas_masjid->saldo); ?></h3>
								</div>
							</div>
							<div class="col-3">
				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-9">
								<div class="d-flex align-items-center align-self-start">
									<h3 class="mb-0"><?= empty($zakat_fitrah->sisa_zakat_fitrah) ? (0) : ($zakat_fitrah->sisa_zakat_fitrah); ?></h3>
								</div>
							</div>
							<div class="col-3">
								<div class="icon icon-box-success">
				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-9">
								<div class="d-flex align-items-center align-self-start">
									<h3 class="mb-0"><?= empty($zakat_mal->sisa_zakat_mal) ? (0) : ($zakat_mal->sisa_zakat_mal); ?></h3>
								</div>
							</div>
							<div class="col-3">
								<div class="icon icon-box-success">
						...
						<?php foreach ($transaksi_terakhir as $transaksi) : ?>
							<div class=" d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
								...
								<div class="align-self-center col-xl-5 col-md-12 col-sm-12 flex-grow text-right text-md-right text-xl-right text-sm-right py-md-2 py-xl-0">
									<h6 class="font-weight-bold mb-0"><?= is_null($transaksi->pemasukan) ? ($transaksi->pengeluaran) . ' <span class="fas fa-arrow-right text-danger ml-2" title="Kas Keluar"></span>' : ($transaksi->pemasukan) . ' <span class="fas fa-arrow-left text-success ml-2" title="Kas Masuk"></span>'; ?></h6>
								</div>
							</div>
						<?php endforeach; ?>
					</div>
								...
								<tbody>
									...
									foreach ($inventaris as $item) : ?>
										<tr>
											...
											<td> <?= $item->stok ?></td>
											<td>
												<div class="badge badge-outline-<?php shuffle($colors);
																				echo $colors[0]; ?>"><?= $item->satuan ?></div>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
